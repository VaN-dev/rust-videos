...
class ReportController extends Controller
{
    ...
    {
        $pendingReports = $this->getDoctrine()->getRepository(Report::class)->getPendingReports();
        $confirmedReports = $this->getDoctrine()->getRepository(Report::class)->getConfirmedReports();
        $dismissedReports = $this->getDoctrine()->getRepository(Report::class)->getDismissedReports();
